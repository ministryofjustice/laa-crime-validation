...
[![CircleCI](https://dl.circleci.com/status-badge/img/gh/ministryofjustice/laa-crime-validation/tree/main.svg?style=shield)](https://dl.circleci.com/status-badge/redirect/gh/ministryofjustice/laa-crime-validation/tree/main)
...
```sh
git clone git@github.com:ministryofjustice/laa-crime-validation.git
...
laa-crime-validation application will be running on http://localhost:8390
...
We have configured a CircleCI code pipelines. You can [log in](https://app.circleci.com/pipelines/github/ministryofjustice/laa-crime-validation) from here to access the pipeline.

### Open API

We have implemented the Open API standard (with Swagger 3). The web link provides a details Rest API with a schema definition. The link can only from local or from dev environment. The swagger link can be found from [here](http://localhost:8400/open-api/docs.html)
